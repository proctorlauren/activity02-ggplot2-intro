...
**Response**: These box plots are three different colors which correlate to a different species. 
...
**Response**: The box plot helps you easily see the median, spread, and the outliers better than the jitterplot. The jitterplot allows you to see the individual data points which cannot be seen with the boxplot.
...
**Response**: The markdown file is a lot easier to read and looks more professional.
...
**Response**: I prefer the jitterplot over hte boxplot because the boxplot over the jitterplot woulf cover the data points.
...
**Response**: ggplot will apply the aesthetic to all layers where in just a specific layer it will be applied to that specific layer.
